...
docker login -u floryos  -p  dckr_pat_DDDDDDDDDDDDDDDDDDDDDDDDD
...
Elimizle terminalden imajları tek tek silmek komutları
					...
					docker rmi floryos/devops-03-pipeline-aws:1.0.10
					docker rmi floryos/devops-03-pipeline-aws:1.0.11
					docker rmi floryos/devops-03-pipeline-aws:1.0.12
					docker rmi floryos/devops-03-pipeline-aws:1.0.13
					docker rmi floryos/devops-03-pipeline-aws:1.0.14
					docker rmi floryos/devops-03-pipeline-aws:latest
...
```
docker login -u floryos  -p  dckr_pat_123456789
```
